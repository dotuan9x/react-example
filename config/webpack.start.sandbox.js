...
module.exports = {
    ...
    plugins: [
        new webpack.DefinePlugin({
            ...
            API_HOST: JSON.stringify(protocol + '://sandbox-antalyser.ants.vn/api/'),
            API_HOST_V3: JSON.stringify(protocol + '://sandbox-antalyser.ants.vn/v3.1/api/'),
            API_LOGGING: JSON.stringify(protocol + '://sandbox-adx.ants.vn/logging'),
            API_LOGGING_ERROR: JSON.stringify(protocol + '://sandbox-adx.ants.vn/logging/v3.1/'),
            ADX_SITE_URL: JSON.stringify(protocol + '://sandbox-adx.ants.vn/v3/'),
            ADX_API_HOST: JSON.stringify(protocol + '://sandbox-adx.ants.vn/v3/api/'),
            ADX_API_HOST_V3: JSON.stringify(protocol + '://sandbox-adx.ants.vn/v3.1/api/'),
            PACKAGE_API_HOST: JSON.stringify(protocol + '://sandbox-a1.ants.vn/v3/package/api/'),
            API_ID: JSON.stringify('76753'),
            ...
            AUTH_ADX_DOMAIN: JSON.stringify(protocol + '://sandbox-ogs.ants.vn/'),
            ST_OGS: JSON.stringify(protocol + '://sandbox-st.ogs.ants.vn/'),
